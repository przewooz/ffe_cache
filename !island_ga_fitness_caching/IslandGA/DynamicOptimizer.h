...
namespace DynamicOptimizer
{
	...
	{
	public:
		CDynamicOptimizer(CProblem<TGenotype, TFenotype> *pcProblem, CLog *pcLog, uint32_t iRandomSeed);
	...
	template <class TGenotype, class TFenotype>
	CDynamicOptimizer<TGenotype, TFenotype> *pcGetDynamicOptimizer(CProblem<TGenotype, TFenotype> *pcProblem, CLog *pcLog, uint32_t iRandomSeed, istream *psSettings, CError *pcError, bool bIsObligatory = true);
}//namespace DynamicOptimizer
