...
class CBinaryCooperativeCoevolutionEvaluation : public CCooperativeCoevolutionEvaluation<CBinaryCoding>
{
public:
	CBinaryCooperativeCoevolutionEvaluation(CEvaluation<CBinaryCoding> *pcActualEvaluation);

	virtual CBinaryCoding *pcCreateSampleFenotype() { return new CBinaryCoding(i_number_of_elements); }

protected:
	virtual void v_prepare_evaluation_fenotype(CBinaryCoding *pcFenotype);
};//class CBinaryCooperativeCoevolutionEvaluation : public CCooperativeCoevolutionEvaluation<CBinaryCoding>
...
private:
	CSteinerTreeSet c_steiner_tree_set_function;
};//class CBinarySteinerTreeSetDynamicEvaluation : public CDynamicEvaluation<CBinaryCoding>
