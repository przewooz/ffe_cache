...
public:
	...
	void vMerge(CBinaryCoding *pcOther);

	void vRepair() {};

	double dComputeDistance(CBinaryCoding *pcOther, CGenePattern *pcGenePattern);
	
	bool bExceededMaxDistance(CBinaryCoding *pcOther, CGenePattern *pcGenePattern, double dMaxDistance, double *pdDistance, bool bOnlyPattern);
