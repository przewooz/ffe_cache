...
class Population {
 public:
  ...
  void improve(Random& rand, CLtgaIndividual & solution, Evaluator& evaluator);
...
private:
  ...
  //bool donate(CLtgaIndividual & solution, float & fitness, CLtgaIndividual & source,
    //  const vector<int> & cluster, Evaluator& evaluator);

  bool donate(CLtgaIndividual & solution, CLtgaIndividual & source,
	    const vector<int> & cluster, Evaluator& evaluator);
