...
using pointer=void (*)(Random & rand, CLtgaIndividual & solution, Evaluator& evaluator);

// Each time an improvement is found, it is immediately kept, with search progressing
// from the modified solution
void first_improvement(Random & rand, CLtgaIndividual & solution, Evaluator& evaluator);
...
void steepest_ascent(Random & rand, CLtgaIndividual  & solution, Evaluator& evaluator);

// Stub function used to turn off local search.  Always returns immediately
// without modifying the solution.
void no_action(Random & rand, CLtgaIndividual & solution, Evaluator& evaluator);
...
void binary_tournament(Random & rand, CLtgaIndividual  & solution, Evaluator& evaluator);
...
void once_each(Random & rand, CLtgaIndividual & solution, Evaluator& evaluator);
